...
<br><br><br><tr>
<a href="<?php echo $root; ?>&amp;act=add"><button class="btn btn-primary" type="button"> <span class="glyphicon glyphicon-pencil"></span>  Tambah Data</button></a><br><br>
...
<a href="<?php echo $root;?>&amp;act=view&amp;id=<?php echo $id;?>" title="Lihat Data"><?php echo $id;?></a>
				...
				<td align="left">
<a href ="<?php echo $root;?>&amp;act=edit&amp;id=<?php echo $id;?>"><button class="btn btn-primary" type="button"> <span class="glyphicon glyphicon-wrench"></span> Edit</button></a>
<a href ="<?php echo $root;?>&amp;act=del&amp;id=<?php echo $id;?>" onclick="return konfirm('<? echo $id;?> ')"><button class="btn btn-primary" type="button"> <span class="glyphicon glyphicon-trash"></span> Hapus</button></td>
</tr>
<?php
$i++;
}
